...
def E_trans(MYOUNG) :
    if MYOUNG=="20 GPa (Béton)" :
        E = 20000000000 #convertir le module de Young à N/m
    if MYOUNG=="30 GPa (Béton)" :
        E = 30000000000 #convertir le module de Young à N/m
    if MYOUNG=="40 GPa (Béton)" :
        E = 40000000000 #convertir le module de Young à N/m
    if MYOUNG=="50 GPa (Béton)" :
        E = 50000000000 #convertir le module de Young à N/m
    if MYOUNG=="196 GPa (Fer)" :
        E = 196000000000 #convertir le module de Young à N/m
    return E
###########################################################################################################
###########################################################################################################
############################################
...
span = st.sidebar.number_input('la portée de la poutre')
...
E = E_trans(E1)
st.sidebar.write("le module de Young est :",E)
...
if YN_DEFLECTION == 'Oui' : 
    ...
    a = st.sidebar.number_input("Entrez la valeur de la base (b)")
    b = st.sidebar.number_input("Entrez la valeur de la hauteur(h)")
    I= (a*(b**3)/12)
